...
@Autonomous(name = "Auto_RedRight_NEW", group = "0")
...
//        sleep(50000);
        ...
        Move(-80, 0.4, Direction.LEFT_RIGHT, 3);
        Move(-5, 0.6, Direction.FRONT_BACK, 1);
        Move(15, 0.5, Direction.FRONT_BACK, 1.5);

        Move(153, 0.5, Direction.LEFT_RIGHT, 3);
        Move(50, 0.5, Direction.FRONT_BACK, 3);
        Elevator(ELE_TOP);
        sleep(500);
        Move(36, 0.5, Direction.LEFT_RIGHT, 2);
        Move(13, 0.5, Direction.FRONT_BACK, 2);
        sleep(550);

        Claw(false);
        sleep(400);

        Move(-13, 0.5, Direction.FRONT_BACK, 1);
