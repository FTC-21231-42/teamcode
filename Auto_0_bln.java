...
@Autonomous(name = "Auto_BlueLeft_NEW", group = "0")
...
//        sleep(50000);
        ...
        Move(90, 0.4, Direction.LEFT_RIGHT, 4);
        Move(-5, 0.6, Direction.FRONT_BACK, 1);
        Move(10, 0.75, Direction.FRONT_BACK, 1.5);

        Move(-153, 0.6, Direction.LEFT_RIGHT, 3);
        Move(50, 0.6, Direction.FRONT_BACK, 3);
        Elevator(ELE_TOP);
        sleep(500);
        Move(-45, 0.6, Direction.LEFT_RIGHT, 2);
        Move(11, 0.6, Direction.FRONT_BACK, 2);
        sleep(550);

        Claw(false);
        sleep(400);

        Move(-15, 0.75, Direction.FRONT_BACK, 1);
        ...
        switch (targetPos) {
            ...
            case TWO:
                ...
                Move(29, 0.75, Direction.LEFT_RIGHT, 1);
